			...
			<nav class="navbar navbar-default navbar-fixed-top libre_navbar">
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="/wiki/index.php/"><img alt="<?=$this->msg( 'tagline' );?>" src="//librewiki.net/skins/Libre/logo.png" style="width: auto; height: 36px" /></a>
					</div>
							...
							<div id="libre_right_toc">
								...
								<ul id = "recent-list">
									...
									<span class="recent-more">
										...
										<a href="/wiki/index.php/특수:최근바뀜" title="최근바뀜문서">more</a>
										<span class="mw-editsection-bracket">]</span>
									</span>
							</div>
							<!-- sidebar ad -->
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu libre_tools" role="menu">
								...
								if ( $title->quickUserCan( 'protect', $user ) ) { ?>
									<li><?php echo Linker::linkKnown( $title, '보호하기', array( 'title' => '문서를 보호합니다. [alt+shift+s]', 'accesskey' => 's' ), array( 'action' => 'protect' ) ); ?></li>
								<?php } ?>
